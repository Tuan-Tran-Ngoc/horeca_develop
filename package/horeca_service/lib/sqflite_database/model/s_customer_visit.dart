...
class CustomerVisit {
  ...
  factory CustomerVisit.fromJson(Map<String, dynamic> json) {
    return CustomerVisit(
      ...
      customerVisitIdSync: JsonUtils.toInt(json['customer_visit_id_sync']),
      shiftReportId: JsonUtils.toInt(json['shift_report_id']),
      ...
      totalCashBack: JsonUtils.toDouble(json['total_cash_back']),
      totalCollection: JsonUtils.toDouble(json['total_collection']),
      newMembership: JsonUtils.toInt(json['new_membership']),
      signature: json['signature'],
      visitStatus: json['visit_status'],
      longitude: JsonUtils.toInt(json['longitude']),
      latitude: JsonUtils.toInt(json['latitude']),
      reason: json['reason'],
      ...
      parentCustomerVisitId: JsonUtils.toInt(json['parent_customer_visit_id']),
      isSample: json['is_sample'],
      isStockCheckCompleted: json['is_stock_check_completed'],
      isSurveyCompleted: json['is_survey_completed'],
      reasonId: JsonUtils.toInt(json['reason_id']),
      totalApproached: JsonUtils.toInt(json['total_approached']),
      totalSmoker: JsonUtils.toInt(json['total_smoker']),
      totalGift: JsonUtils.toInt(json['total_gift']),
    );
  }
